...
namespace Descript
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Descript.AutoSDKRetryOptions Retry { get; set; } = new global::Descript.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Descript.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Descript.IAutoSDKHook>();
        ...
        public global::Descript.AutoSDKClientOptions AddHook(
            global::Descript.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Descript.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Descript.AutoSDKClientOptions UseAuthorizationProvider(
            global::Descript.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Descript.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Descript.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Descript.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Descript.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Descript.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Descript.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Descript.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Descript.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Descript.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Descript.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Descript.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Descript.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Descript.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Descript.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Descript.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Descript.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Descript.AutoSDKClientOptions clientOptions,
            global::Descript.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Descript.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Descript.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Descript.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Descript.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Descript.IAutoSDKHook, global::Descript.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Descript.AutoSDKHookContext context)
        {
