...
namespace Descript.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "Descript.CLI";
    private const string UserSecretApiKeyName = "DESCRIPT_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"DESCRIPT_API_KEY"];
    private const string CredentialFileDirectoryName = ".descript";

    public static async global::System.Threading.Tasks.Task<global::Descript.DescriptClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Descript.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Descript.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Descript.DescriptClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Descript.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Descript.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Descript.EndPointAuthorization).GetProperty("SchemeId");
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("DESCRIPT_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Descript.ApiException exception)
    {
        var builder = new StringBuilder();
