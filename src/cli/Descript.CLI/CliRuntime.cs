...
internal static class CliRuntime
{
    ...
    public static async Task<global::Descript.DescriptClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Descript.ApiException exception)
    {
        var builder = new StringBuilder();
